...
const Hero = ({
  ...
  <div className=" flex flex-col justify-center items-start  sm:row-start-1">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-light text-black-600 leading-normal text-left sm:text-right w-full">
            Welcome to 
          </h1>
<strong className="text-4xl lg:text-5xl xl:text-6xl  text-black-600 sm:leading-normal sm:font-bold sm:text-right">CVR Alumni Network </strong>
