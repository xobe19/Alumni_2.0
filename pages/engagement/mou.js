...
<div class="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 cursor-pointer mb-5 md:mr-10 md:mb-0">
    <a href="#" class="w-full block">
        <img alt="blog photo" src="/mdx.png" class=" w-full object-cover"/>
...
<div class="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 cursor-pointer" >
    <a href="#" class="w-full block h-full">
        <img alt="blog photo" src="/mdx_mou.png" class=" w-full object-cover"/>
        <div class="bg-white  w-full p-4">
            <p class="text-indigo-500 text-md font-medium">
                MDX University
            </p>
            ...
            <p class="text-gray-400  font-light text-md">
Dr David Windridge and Dr Santosh Tirunagri have joined the online MoU signing cermony executed between MDX university, UK and CVR College of Engineering on 25 June 2021.

Under this MoU, both the institutions work on a mutually congruent set of objectives and collaborate on Scientific Research and Publications.
            </p>
        </div>
    </a>
</div>
